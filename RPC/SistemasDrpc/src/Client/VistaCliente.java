...
cliente c;
     ...
     */
    public VistaCliente() throws MalformedURLException {
        initComponents();
        c = new cliente();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        c.insertData(this.jTextField1.getText().toString(), this.jTextField2.getText().toString(),this.jTextField3.getText().toString());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
try{
                new VistaCliente().setVisible(true);} catch (MalformedURLException ex) {
